...
class Utils(commands.Cog):
	...
	@commands.has_permissions(manage_channels=True)
	@commands.bot_has_permissions(manage_channels=True)
	async def cname(self, ctx, channel: typing.Optional[discord.abc.GuildChannel]=None, *, name=None):
		"""
	...
	@commands.has_permissions(manage_channels=True)
	@commands.bot_has_permissions(manage_channels=True)
	async def delchan(self, ctx, channel: typing.Optional[discord.abc.GuildChannel]=None, *, reason="None given."):
		"""
